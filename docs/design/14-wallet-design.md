...
- `docs/protocol.md (§2–3)` - account and key model.
- `docs/protocol.md (§4)` - Name Note artifact.
- `docs/protocol.md (§6)` - Treasury request and OTP relay memo
  formats.
- `docs/protocol.md (§8)` - claim/update/release flow including
  the Treasury OTP-relay path.
- `docs/design/08-chain-sync.md` - sync, checkpoint, reorg expectations.
- `docs/design/09-transaction-assembly.md` - Registry self-funds Name Note
  fees; Treasury funds OTP relay fees.
- `docs/design/12-programming-model.md` - the three-layer model this
  wallet lives in.
- `docs/design/13-implementation-slices.md` - slices 2, 3, and 4 are
