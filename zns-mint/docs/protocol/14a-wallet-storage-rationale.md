...
- `docs/protocol/14-wallet-design.md` — the wallet design this rationale
  supports.
- `docs/protocol/08-chain-sync.md` — sync, checkpoint, and reorg
  expectations.
- `docs/protocol/02-accounts-and-keys.md` — key model; seed injection via
  TEE.