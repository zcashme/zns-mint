...
- `Wallet::new` asks for the origin `ChainState` and the pre-birthday
  ...
  drops the whole local — the frontier-only wallet and the
  tree-ahead-of-map divergence are unconstructible.
